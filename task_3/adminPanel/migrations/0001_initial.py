# Generated by Django 2.2.8 on 2022-10-11 06:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BadgeDetailsModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge', models.IntegerField()),
                ('badgeamount', models.IntegerField()),
                ('sponsorbonus', models.IntegerField()),
            ],
        ),
        migrations.CreateModel(
            name='BonusHistoryModel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=32)),
                ('sponsor', models.CharField(max_length=32)),
                ('bonusamount', models.IntegerField()),
                ('purchasedamount', models.IntegerField()),
            ],
        ),
        migrations.CreateModel(
            name='GenerateCoupon',
            fields=[
                ...
                ('couponid', models.TextField(max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_sale', models.FloatField(default=0, max_length=100)),
